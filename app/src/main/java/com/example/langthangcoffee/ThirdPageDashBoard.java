...
public class ThirdPageDashBoard extends Fragment implements View.OnClickListener {
    ...
    private List<Food> getListFood() {
        ...
        //cafe
        list.add(new Food(R.drawable.cf1,"Cà phê đen","25000VND",Food.TYPE_CAFE));
        list.add(new Food(R.drawable.cf2,"Cà phê sữa","25000VND",Food.TYPE_CAFE));
        list.add(new Food(R.drawable.cf3,"Cà phê dừa","25000VND",Food.TYPE_CAFE));
        list.add(new Food(R.drawable.cf4,"Cà phê phô mai","25000VND",Food.TYPE_CAFE));
        list.add(new Food(R.drawable.cf5,"Milo","25000 VND",Food.TYPE_CAFE));
        //tra sua
        list.add(new Food(R.drawable.ts1,"Trà sữa đường đen","25000VND",Food.TYPE_TRASUA));
        list.add(new Food(R.drawable.ts2,"Trà sữa matcha","25000VND",Food.TYPE_TRASUA));
        list.add(new Food(R.drawable.ts3,"Trà sữa khoai môn","25000VND",Food.TYPE_TRASUA));
        list.add(new Food(R.drawable.ts4,"Trà sữa cheese","25000VND",Food.TYPE_TRASUA));
        list.add(new Food(R.drawable.ts5,"Trà sữa cacao","25000VND",Food.TYPE_TRASUA));
        //soda
        list.add(new Food(R.drawable.sd1,"Soda đào","30000VND",Food.TYPE_SODA));
        list.add(new Food(R.drawable.sd2,"Soda nho","30000VND",Food.TYPE_SODA));
        list.add(new Food(R.drawable.sd3,"Soda dâu","30000VND",Food.TYPE_SODA));
        list.add(new Food(R.drawable.sd4,"Soda chanh","30000VND",Food.TYPE_SODA));
        list.add(new Food(R.drawable.sd5,"Soda cam","30000VND",Food.TYPE_SODA));
