...
public class ChiTietDatHangDangGiaoFragment extends Fragment {
    ...
    ChiTietDatHangDangGiaoFragment chiTietDatHangDangChoFragment;
    TextView tvInfoShip, tvItemThanhTien, tvItemPhiGiaoHang, tvItemThanhToan, tvVoucher, tvMaDonHang;

    public ChiTietDatHangDangGiaoFragment() {
    }
