...
import com.example.langthangcoffee.adapters.BillOrderAdminHoanThanhAdapter;
...
public class ChiTietDatHangAdminHoanThanhFragment extends Fragment {
    ...
    ChiTietDatHangAdminHoanThanhFragment chiTietDatHangDangChoFragment;
    TextView tvInfoShip, tvItemThanhTien, tvItemPhiGiaoHang, tvItemThanhToan, tvVoucher, tvMaDonHang, tvTaiKhoan;

    public ChiTietDatHangAdminHoanThanhFragment(BillOrderAdminHoanThanhAdapter billOrderAdminHoanThanhAdapter) {
        this.billOrderAdminHoanThanhAdapter = billOrderAdminHoanThanhAdapter;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ViewGroup v = (ViewGroup) inflater.inflate(R.layout.fragment_trang_thong_tin_bill_hoan_tat_admin, container, false);
