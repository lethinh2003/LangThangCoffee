...
public class QuanLySanPhamChiTietFragment extends Fragment implements FoodOrderToppingAdapter.EventListener {
    ...
    Button btnPriceDetail, btnUploadHinhAnh, btnCapNhat, btnXoaSanPham;
    ...
    public QuanLySanPhamChiTietFragment(FoodOrder foodOrder) {
        this.foodOrder = new FoodOrder(foodOrder);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup v = (ViewGroup) inflater.inflate(R.layout.fragment_trang_quan_ly_san_pham_chitiet, container, false);
        ...
        btnXoaSanPham = v.findViewById(R.id.btn_xoa_san_pham);
        ...
        for (int i = 0; i < danhMucSanPhamArrayList.size(); i++) {
            if (foodOrder.getTenDanhMuc().equals(danhMucSanPhamArrayList.get(i).getTenDanhMuc())) {
                indexPositionDefaultSpinner = i;
                break;
            }
        }
        spinnerDanhMuc.setSelection(indexPositionDefaultSpinner);
        ...
        btnCapNhat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Xác nhận cập nhật sản phẩm");
                builder.setMessage("Có chắc muốn cập nhật sản phẩm này?");
        ...
        btnXoaSanPham.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                title.setText("Xác nhận xóa sản phẩm");
                title.setTextColor(R.color.black);
                builder.setCustomTitle(title);


                builder.setMessage("Có chắc muốn xóa sản phẩm này?");
                builder.setPositiveButton("Confirm",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
