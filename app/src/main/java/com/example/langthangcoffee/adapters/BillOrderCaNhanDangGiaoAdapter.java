...
import com.example.langthangcoffee.fragments.ChiTietDatHangDangGiaoFragment;
...
public class BillOrderCaNhanDangGiaoAdapter extends RecyclerView.Adapter<BillOrderCaNhanDangGiaoAdapter.FoodOrderViewHolder> {
    private List<DonHang> mBillOrder;
    MainActivity mainActivity;


    public BillOrderCaNhanDangGiaoAdapter(List<DonHang> mBillOrder, MainActivity mainActivity) {
    ...
    public void onBindViewHolder(@NonNull final FoodOrderViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.lnItemDonHang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ChiTietDatHangDangGiaoFragment chiTietDatHangDangChoFragment = new ChiTietDatHangDangGiaoFragment();
