...
import com.example.langthangcoffee.fragments.ChiTietDatHangHoanThanhFragment;
...
public class BillOrderCaNhanHoanThanhAdapter extends RecyclerView.Adapter<BillOrderCaNhanHoanThanhAdapter.FoodOrderViewHolder> {
    private List<DonHang> mBillOrder;
    MainActivity mainActivity;


    public BillOrderCaNhanHoanThanhAdapter(List<DonHang> mBillOrder,     MainActivity mainActivity) {
    ...
    public void onBindViewHolder(@NonNull final FoodOrderViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.lnItemDonHang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ChiTietDatHangHoanThanhFragment chiTietDatHangDangChoFragment = new ChiTietDatHangHoanThanhFragment();
